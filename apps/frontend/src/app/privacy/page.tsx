...
export const metadata: Metadata = {
  ...
  description: 'Learn how Oddins Odds protects your data and maintains your privacy. Our comprehensive privacy policy covers data collection, affiliate tracking, and security.',
};
