...
export default function TeamsDirectory() {
  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6">
      <h2 className="text-xl sm:text-2xl font-black text-slate-800">Football Teams Statistics for All Countries</h2>
              ...
              {openLeagues.includes(group.league) && (
                <div className="divide-y divide-slate-50 px-2 animate-in fade-in slide-in-from-top-2 duration-300">
                  {group.teams.map((team) => (
                    <div key={team.id} className="group flex items-center justify-between p-3 sm:p-4 hover:bg-slate-50 transition-all rounded-xl cursor-pointer">
