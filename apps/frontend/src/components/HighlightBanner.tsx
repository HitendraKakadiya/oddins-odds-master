export default function HighlightBanner() {
  return (
    <div className="bg-brand-emerald rounded-[32px] p-8 md:p-12 text-white relative overflow-hidden mb-12 shadow-2xl shadow-brand-emerald/20 border border-white/10 group transition-all hover:shadow-brand-emerald/30">
      ...
      <div className="absolute left-0 bottom-0 w-48 h-48 bg-brand-emerald/10 rounded-full translate-y-1/2 -translate-x-1/2 blur-2xl"></div>
