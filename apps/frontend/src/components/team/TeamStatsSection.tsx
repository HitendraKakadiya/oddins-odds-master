      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="p-8 flex-1 flex flex-col justify-center items-center">
            <div className="text-center mb-6">
                <span className="text-5xl font-black text-primary-600">In 1 days</span>
          ...
          <div className="w-full space-y-4 max-w-xs">
            <div className="flex justify-between items-center text-sm font-bold">
                ...
                <span className="text-primary-600">{winRate}%</span>
            </div>
          ...
          <button className="mt-8 bg-primary-600 text-white px-8 py-3 rounded-2xl font-black text-sm shadow-lg shadow-primary-100 transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">
      ...
      <div className="flex flex-col justify-center space-y-8 px-4">
        ...
        <div className="grid grid-cols-2 gap-6">
            <div className="flex items-start">
                <div className="w-2 h-10 bg-primary-600 rounded-full mr-4"></div>
                <div>
            ...
            <div className="flex items-start">
                <div className="w-2 h-10 bg-primary-200 rounded-full mr-4"></div>
                <div>
