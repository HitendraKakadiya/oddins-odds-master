        ...
        {offers.map((offer, idx) => (
          ...
          >
            ...
            <div className="p-6 sm:p-8 flex-1 flex flex-col">
              <h3 className="text-xl sm:text-2xl font-black text-brand-emerald mb-3 group-hover:text-brand-emerald transition-colors line-clamp-2 leading-tight">
                {offer.title}
              </h3>
              <p className="text-gray-600 text-sm sm:text-base mb-6 line-clamp-3 leading-relaxed font-medium">
                {offer.description}
              </p>
              <div className="mt-auto flex items-center font-bold text-brand-emerald group-hover:gap-2 transition-all">
