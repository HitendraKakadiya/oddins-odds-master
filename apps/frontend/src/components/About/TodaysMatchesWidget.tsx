...
export default function TodaysMatchesWidget() {
  ...
  return (
    <div className="bg-brand-indigo rounded-xl overflow-hidden shadow-lg mt-8">
      <div className="bg-brand-indigo p-4 text-center">
        <h3 className="text-white font-bold text-sm">Today&apos;s Matches!</h3>
      </div>
          ...
          <div key={match.id} className="bg-white rounded-lg p-3 shadow-sm">
            <div className="flex items-center justify-between mb-2 border-b border-gray-100 pb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-gray-700">{match.league.name}</span>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                 <div className="flex items-center gap-2">
                    {/* Placeholder logos */}
                    <div className="w-4 h-4 bg-red-100 rounded-full flex items-center justify-center text-[8px]">🛡️</div> 
                    <span className="text-xs font-medium text-gray-800">{match.home}</span>
                 </div>
                 <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-gray-100 rounded-full flex items-center justify-center text-[8px]">🛡️</div>
